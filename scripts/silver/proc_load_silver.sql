...
-- ===================================================================================
-- LOADING ALL THE VALUES IN SILVER LAYER AFTER CLENSING DATA 
-- ===================================================================================
...
BEGIN
	BEGIN TRY
		...
		PRINT '>> Loading Silver Layer Tables:' + CAST(DATEDIFF(second,@whole_start,@whole_end) AS NVARCHAR) + ' seconds';
